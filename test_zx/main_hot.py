...
from draw_hot import draw_heatmap
...
# draw_heatmap(similarity_matrix,labels_list,label_order_list)
np.savetxt("confusion_matrix_round_3.csv", similarity_matrix, delimiter=" ",fmt="%.2f")